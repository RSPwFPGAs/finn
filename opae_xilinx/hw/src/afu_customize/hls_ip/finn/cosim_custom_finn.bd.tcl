...
proc create_hier_cell_afu_user_interface { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type clk ip_axi_aclk_ctrl
  create_bd_pin -dir O -type clk ip_axi_aclk_data
  create_bd_pin -dir O -type rst ip_axi_aresetn_ctrl
  create_bd_pin -dir O -type rst ip_axi_aresetn_data
...
proc create_hier_cell_pcie_axi_bridge { parentCell nameHier } {
 ...
 ] [get_bd_pins /FIM/FIU/pcie_axi_bridge/QEMUPCIeBridge_0/i_axi_ctl_aclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
 ] [get_bd_pins /FIM/FIU/pcie_axi_bridge/QEMUPCIeBridge_0/o_axi_aclk]
...
proc create_hier_cell_AFU { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins AFU_base_ip/IP_S_AXI_FULL_DATA] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net FIM_axi_aclk_ctrl_port [get_bd_pins AFU/axi_aclk_ctrl_port] [get_bd_pins FIM/axi_aclk_ctrl_port]
  connect_bd_net -net FIM_axi_aclk_data_port [get_bd_pins AFU/axi_aclk_data_port] [get_bd_pins FIM/axi_aclk_data_port]
  connect_bd_net -net FIM_axi_aresetn_ctrl_port [get_bd_pins AFU/axi_aresetn_ctrl_port] [get_bd_pins FIM/axi_aresetn_ctrl_port]
  connect_bd_net -net FIM_axi_aresetn_data_port [get_bd_pins AFU/axi_aresetn_data_port] [get_bd_pins FIM/axi_aresetn_data_port]
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/axi_dma_0/Data_MM2S] [get_bd_addr_segs FIM/FIU/pcie_axi_bridge/QEMUPCIeBridge_0/S_AXI/BAR0] SEG_QEMUPCIeBridge_0_BAR0
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/axi_dma_0/Data_S2MM] [get_bd_addr_segs FIM/FIU/pcie_axi_bridge/QEMUPCIeBridge_0/S_AXI/BAR0] SEG_QEMUPCIeBridge_0_BAR0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00020000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs AFU/AFU_base_ip/AFU_core/feature_ram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem01
  create_bd_addr_seg -range 0x00001000 -offset 0x00021000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs AFU/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00020000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/QEMUPCIeBridge_0/M_AXI] [get_bd_addr_segs AFU/AFU_base_ip/AFU_core/feature_ram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem03
  create_bd_addr_seg -range 0x00001000 -offset 0x00021000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/QEMUPCIeBridge_0/M_AXI] [get_bd_addr_segs AFU/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
